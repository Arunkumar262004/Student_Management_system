      ...
      <div className="ap">
        ...
        <div className="ap-right">
          <div className="ap-box">
            ...
            <form onSubmit={handleSubmit((d) => mutate(d))}>
              <div className="mb-3">
                ...
                <input
                  ...
                  placeholder="Arun"
                  className={`form-control fi ${errors.name ? 'is-invalid' : ''}`}
                />
              ...
              <div className="mb-3">
                ...
                <select {...register('role')} className="form-select fi">
            ...
            <p className="ap-ft">Already have an account? <Link to="/login">Sign in</Link></p>
          </div>
        </div>
      </div>
    </>
